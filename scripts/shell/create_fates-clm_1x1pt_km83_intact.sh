...
export CESM_CASE_NAME=fates-clm5_${CLM_USRDAT_NAME}_${experiment}_${CESM_COMPSET}test
export ARCHIVE_DIR=${PROJECT_DIR}/cesm_archive
...
export finidat=${INPUTDATA_DIR}/user_inputdata/${CLM_USRDAT_NAME}/fates-clm5_1x1pt_km83_intact_I2000Clm50FatesGs.clm2.r.2801-01-01-00000.nc
# Modify user_nl_clm
cat >> user_nl_clm << EOF
  co2_ppmv = 400.0
  finidat= '${finidat}'
  ...
  fsurdat = '${fsurdat}'
  hist_fincl1='BA_SCPF','M1_SCPF','M2_SCPF','M3_SCPF','M4_SCPF','M5_SCPF','M6_SCPF','M7_SCPF','MORTALITY_CANOPY_SCPF','MORTALITY_UNDERSTORY_SCPF','DDBH_SCPF','NPLANT_SCPF', 'NPLANT_CANOPY_SCPF', 'NPLANT_UNDERSTORY_SCPF','CWD_STOCK_COL', 'PFTbiomass', 'PFTleafbiomass', 'ED_biomass','BIOMASS_CANOPY','BIOMASS_UNDERSTORY','AR', 'AR_CANOPY','AR_UNDERSTORY','NEP','NPP','GPP','GPP_CANOPY','GPP_UNDERSTORY','HR', 'LITTER_IN','LITTER_OUT', 'FCEV','FCTR','FGEV','FSDS','FLDS', 'FIRE', 'FSR' ,'FSH','FGR' ,'TLAI','LAISUN_TOP_CAN','LAISHA_TOP_CAN','SOILWATER_10CM' ,'QSOIL' ,'QVEGE' ,'QVEGT' ,'H2OCAN'
  use_luna = .false.
  use_fates= .true.
