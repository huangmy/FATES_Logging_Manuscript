...
export experiment=intact.ensm0063.CLlow
...
export finidat=${INPUTDATA_DIR}/user_inputdata/${CLM_USRDAT_NAME}/fates-clm5_1x1pt_km83_intact.ensm0063_spinup_I2000Clm50FatesGs.clm2.r.3002-01-0 -00000.nc
# Modify user_nl_clm
cat >> user_nl_clm << EOF
  co2_ppmv = 400.0
  finidat = '${finidat}'
