...
export experiment=intact.ensm0090
export CESM_CASE_NAME=fates-clm5_${CLM_USRDAT_NAME}_${experiment}_spinup_${CESM_COMPSET}
export ARCHIVE_DIR=${PROJECT_DIR}/cesm_archive
...
./xmlchange  --file env_batch.xml --id JOB_WALLCLOCK_TIME --val "36:00:00"
...
./xmlchange --file env_run.xml --id STOP_N --val 1001
